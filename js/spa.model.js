...
spa.model = (function () {
    ...
    completeLogin = function (user_list) {
        ...
        stateMap.people_cid_map[user_map] = stateMap.user;

        chat.join();
        $(spa).trigger('spa-login', [stateMap.user]);
    };
    //End complet login
    ...
    chat = (function () {
        ...
        _publish_listchange = function (arg_list) {
            ...
            $(spa).trigger('spa-listchange', [arg_list]);
        };
        ...
        _publish_updatechat = function (arg_list) {
            ...
            else if (msg_map.id !== stateMap.user.id
                && msg_map.sender_id !== chatee.id) {
                $(spa).trigger('spa-updatechat', [msg_map]);
            }
        };
